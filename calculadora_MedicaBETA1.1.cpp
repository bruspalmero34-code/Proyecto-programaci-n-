...
cout << "==================================================" << endl;
    ...
    float alturaCM = altura * 100;    // Convertir altura a centímetros
    asc = sqrt((alturaCM * peso) / 3600);

    cout << "====================================================" << endl;
    cout << "El área de superficie corporal (ASC) es: | " << asc << " m2 |" << endl;
    cout << "====================================================" << endl;
    pausa();
}
...
void buscarPacienteEnArchivo() {
    ...
    string busqueda;
    cout << "========================================" << endl;
    cout << "   BUSQUEDA DE PACIENTES REGISTRADOS     \n";
    cout << "========================================" << endl;
    cout << "Ingrese el apellido o nombre del paciente a buscar: ";cin >> busqueda;
    cout << "----------------------------------------" << endl;
    string linea;
